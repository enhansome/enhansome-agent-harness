...
* [Everything Claude Code](https://github.com/affaan-m/everything-claude-code) ⭐ 256,810 | 🐛 185 | 🌐 JavaScript | 📅 2026-09-12 — Skills, instincts, memory, and security harness for Claude Code and Codex.
* [Oh My OpenCode](https://github.com/code-yeongyu/oh-my-opencode) ⭐ 68,964 | 🐛 993 | 🌐 TypeScript | 📅 2026-09-12 — Performance optimization harness for OpenCode with 44 lifecycle hooks.
* [Warp](https://github.com/warpdotdev/Warp) ⭐ 64,981 | 🐛 5,230 | 🌐 Rust | 📅 2026-09-12 — Agentic development environment built for coding with multiple AI agents.
* [Oh My Claude Code](https://github.com/Yeachan-Heo/oh-my-claudecode) ⭐ 39,109 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-12 — Teams-first multi-agent orchestration for Claude Code. Ultrapilot mode runs 5 Claude Code instances in parallel Git worktrees, compressing 4-hour tasks to 50 minutes.
* [Oh My Codex](https://github.com/Yeachan-Heo/oh-my-codex) ⭐ 33,104 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-11 — Hooks, agent teams, and HUD for Codex. Adds lifecycle hooks and multi-agent coordination on top of OpenAI's CLI agent.
* [Vibe Kanban](https://github.com/BloopAI/vibe-kanban) ⭐ 28,061 | 🐛 540 | 🌐 Rust | 📅 2026-09-12 — Kanban-based orchestrator with git worktree isolation per agent. Supports 10+ coding agents. Enforces the "one agent, one worktree" pattern that keeps parallel execution clean.
* [Gas Town](https://github.com/gastownhall/gastown) ⭐ 18,020 | 🐛 461 | 🌐 Go | 📅 2026-09-10 — Steve Yegge's multi-agent workspace manager. Docker-based with a "Mayor" orchestrator that distributes work as "beads" across agent "convoys." Includes web dashboard, git worktree isolation, and hook-based work state management.
* [Trellis](https://github.com/mindfold-ai/trellis) ⭐ 14,608 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-11 — Git worktree-based multi-agent parallel harness. Isolates agents into separate worktrees for clean concurrent execution.
* [Composio Agent Orchestrator](https://github.com/ComposioHQ/agent-orchestrator) ⭐ 11,717 | 🐛 670 | 🌐 Go | 📅 2026-09-12 — Agentic orchestrator for parallel coding agents. Plans tasks, spawns agents in isolated worktrees, autonomously handles CI fixes, merge conflicts, and code reviews.
* [Emdash](https://github.com/generalaction/emdash) ⭐ 5,728 | 🐛 95 | 🌐 TypeScript | 📅 2026-09-11 — Open-source Agentic Development Environment (YC W26). Runs parallel agents in isolated worktrees, locally or over SSH — making the "corrections are cheap" principle practical for remote teams.
* [Scion](https://github.com/GoogleCloudPlatform/scion) ⭐ 1,693 | 🐛 55 | 🌐 Go | 📅 2026-09-11 — Google's open-source multi-agent orchestration testbed. Manages "deep agents" (Claude Code, Gemini CLI, Codex) as isolated, concurrent processes — each gets its own container, git worktree, and credentials. Agent memory, chatrooms, and task management as orthogonal, pluggable modules.
...
* [Oh My AG](https://github.com/first-fluke/oh-my-ag) ⭐ 1,288 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-12 — Multi-agent harness for Google Antigravity with 6 specialized agents.
* [Desplega Agent Swarm](https://github.com/desplega-ai/agent-swarm) ⭐ 764 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-12 — Open-source multi-agent orchestration framework. Coordinates specialized AI agents (Claude Code-powered) through task delegation, session continuity, shared memory, and service discovery. Features include epics, scheduling, Slack integration, and cross-agent communication channels.
...
* [Symphony](https://github.com/openai/symphony) ⭐ 27,157 | 🐛 8 | 🌐 Elixir | 📅 2026-09-09 — OpenAI's reference implementation of harness engineering. A daemon that polls Linear issues, spawns isolated Codex agents per task, and delivers PRs. Embodies "humans steer, agents execute" at scale.
* [ralph](https://github.com/snarktank/ralph) ⭐ 21,772 | 🐛 74 | 🌐 TypeScript | 📅 2026-02-02 — PRD-driven autonomous agent loop. Runs until all PRD items are completed, bridging spec-to-execution for single-agent workflows.
...
* [DeerFlow 2.0](https://github.com/bytedance/deer-flow) ⭐ 82,313 | 🐛 896 | 🌐 Python | 📅 2026-09-12 — ByteDance's open-source SuperAgent harness. Skill system with on-demand loading, sub-agent orchestration, sandboxed execution, and persistent memory. Built on LangGraph/LangChain.
...
* [Deep Agents](https://github.com/langchain-ai/deepagents) ⭐ 29,336 | 🐛 202 | 🌐 Python | 📅 2026-09-12 — Agent harness built on LangChain/LangGraph. Implements progressive disclosure through planning tools and subagent spawning — agents discover context layer by layer rather than loading everything upfront.
* [Compound Engineering Plugin](https://github.com/EveryInc/compound-engineering-plugin) ⭐ 25,036 | 🐛 101 | 🌐 TypeScript | 📅 2026-09-12 — Cross-agent standardized plugin for Claude Code, Codex, and Cursor. Unified harness interface across multiple coding agents.
* [GenericAgent](https://github.com/lsdefine/GenericAgent) ⭐ 14,172 | 🐛 166 | 🌐 Python | 📅 2026-09-11 — Self-evolving agent framework. Grows a skill tree from 3.3K lines of seed code, achieving 6x token efficiency reduction through learned capabilities.
* [Microsoft Agent Framework](https://github.com/microsoft/agent-framework) ⭐ 13,490 | 🐛 642 | 🌐 Python | 📅 2026-09-11 — Microsoft's framework for building, orchestrating, and deploying AI agents and multi-agent workflows. Supports Python and .NET with structured orchestration patterns.
* [Hive](https://github.com/aden-hive/hive) ⭐ 11,038 | 🐛 1,361 | 🌐 Python | 📅 2026-09-05 — Outcome-driven agent framework. Queen agent generates agent graphs, harness manages state, checkpoints, and cost tracking.
* [EvoMap Evolver](https://github.com/EvoMap/evolver) ⭐ 9,070 | 🐛 23 | 🌐 JavaScript | 📅 2026-09-06 — Genome Evolution Protocol (GEP) engine for agent self-evolution. Applies evolutionary algorithms to optimize agent behavior and harness configuration over time.
* [Desloppify](https://github.com/peteromallet/desloppify) ⭐ 3,119 | 🐛 120 | 🌐 Python | 📅 2026-05-13 — Agent harness focused on making AI-generated code well-engineered.
...
* [Harness Kit](https://github.com/deepklarity/harness-kit) ⭐ 98 | 🐛 0 | 🌐 Python | 📅 2026-07-15 — Patterns and engineering practices for building with AI agents.
...
* [OpenClaw](https://github.com/openclaw/openclaw) ⭐ 389,490 | 🐛 6,942 | 🌐 TypeScript | 📅 2026-09-12 — AI agent runtime. Orchestrates agents across messaging channels with skill system, sub-agent spawning, and persistent session management.
* [LangGraph](https://github.com/langchain-ai/langgraph) ⭐ 41,519 | 🐛 778 | 🌐 Python | 📅 2026-09-11 — Library for building stateful, multi-actor applications with LLMs. Functions as an agent runtime managing execution, state, and coordination of agentic workflows. Built on LangChain.
* [Nanoclaw](https://github.com/qwibitai/nanoclaw) ⭐ 30,745 | 🐛 1,099 | 🌐 TypeScript | 📅 2026-09-12 — Lightweight alternative to OpenClaw that runs in containers. Connects to WhatsApp, Telegram, and other channels with a security-first, container-based isolation model.
...
* [claude-mem](https://github.com/thedotmack/claude-mem) ⭐ 93,715 | 🐛 196 | 🌐 TypeScript | 📅 2026-09-11 — Automatic session capture with AI compression and injection into future sessions. Solves the stateless-agent problem by giving Claude Code persistent memory across runs.
* [Hindsight](https://github.com/vectorize-io/hindsight) ⭐ 23,499 | 🐛 92 | 🌐 Python | 📅 2026-09-11 — Agent memory that learns. Automatically captures, indexes, and retrieves agent execution history to improve future task performance.
* [CodeBurn](https://github.com/AgentSeal/codeburn) ⭐ 10,979 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-12 — Claude Code token usage analytics. Breaks down token consumption by task, enabling cost attribution and optimization.
* [Honcho](https://github.com/plastic-labs/honcho) ⭐ 7,130 | 🐛 142 | 🌐 Python | 📅 2026-09-11 — Agent state memory library. Provides the persistence layer for stateful agents — session history, user context, and learned preferences.
...
* [Hermes Agent](https://github.com/NousResearch/hermes-agent) ⭐ 244,767 | 🐛 42,300 | 🌐 Python | 📅 2026-09-12 — Self-improving agent loop with persistent memory and self-generated skills. The agent that grows with you — learns from execution history and evolves its own capabilities over time.
* [OpenCode](https://github.com/sst/opencode) ⭐ 206,842 | 🐛 5,767 | 🌐 TypeScript | 📅 2026-09-12 — Open-source coding agent with a plugin system (44 lifecycle hooks), server mode HTTP API, and TypeScript SDK. The most extensible harness integration point for custom workflows.
* [Codex](https://github.com/openai/codex) ⭐ 123,546 | 🐛 16,778 | 🌐 Rust | 📅 2026-09-12 — OpenAI's coding agent. Cloud and CLI modes.
* [Gemini CLI](https://github.com/google-gemini/gemini-cli) ⭐ 106,940 | 🐛 818 | 🌐 TypeScript | 📅 2026-09-12 — Google's CLI coding agent.
* [Pi Mono](https://github.com/badlogic/pi-mono) ⭐ 104,312 | 🐛 207 | 🌐 TypeScript | 📅 2026-09-11 — AI agent toolkit: coding agent CLI, unified LLM API, TUI & web UI libraries, Slack bot, vLLM pods. Full-stack agent infrastructure in a single monorepo.
* [Aider](https://github.com/paul-gauthier/aider) ⭐ 48,912 | 🐛 1,861 | 🌐 Python | 📅 2026-05-22 — AI pair programming in your terminal.
* [GitHub Copilot CLI](https://github.com/github/copilot-cli) ⭐ 11,166 | 🐛 2,364 | 🌐 Shell | 📅 2026-09-11 — GitHub's CLI coding agent.
...
* [Spec Kit](https://github.com/github/spec-kit) ⭐ 135,937 | 🐛 309 | 🌐 Python | 📅 2026-09-12 — GitHub's spec generation toolkit.
* [Archon](https://github.com/coleam00/Archon) ⭐ 23,437 | 🐛 318 | 🌐 TypeScript | 📅 2026-09-11 — First open-source harness builder. Makes AI coding deterministic and repeatable through structured harness configuration.
* [Open Pencil](https://github.com/open-pencil/open-pencil) ⭐ 8,277 | 🐛 48 | 🌐 TypeScript | 📅 2026-09-11 — Open-source AI-native design editor (MIT). 75+ tools and an MCP server let coding agents read/write .fig files headlessly.
...
* [harness-kit](https://github.com/deepklarity/harness-kit) ⭐ 98 | 🐛 0 | 🌐 Python | 📅 2026-07-15 — Engineering patterns for building with AI agents.
